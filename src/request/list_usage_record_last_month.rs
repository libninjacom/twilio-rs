...
#[derive(Clone)]
pub struct ListUsageRecordLastMonthRequest<'a> {
...
impl<'a> ListUsageRecordLastMonthRequest<'a> {
    pub async fn send(self) -> ::httpclient::InMemoryResult<serde_json::Value> {
        let mut r = self
            ...
            .get(
                &format!(
                    "/2010-04-01/Accounts/{account_sid}/Usage/Records/LastMonth.json",
...
impl<'a> ::std::future::IntoFuture for ListUsageRecordLastMonthRequest<'a> {
