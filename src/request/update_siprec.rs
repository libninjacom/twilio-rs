...
#[derive(Clone)]
pub struct UpdateSiprecRequest<'a> {
    pub(crate) http_client: &'a TwilioClient,
    pub account_sid: String,
    pub call_sid: String,
    pub sid: String,
}
impl<'a> UpdateSiprecRequest<'a> {
    pub async fn send(self) -> ::httpclient::InMemoryResult<ApiV2010AccountCallSiprec> {
        let mut r = self
            ...
            .post(
                &format!(
                    "/2010-04-01/Accounts/{account_sid}/Calls/{call_sid}/Siprec/{sid}.json",
...
impl<'a> ::std::future::IntoFuture for UpdateSiprecRequest<'a> {
