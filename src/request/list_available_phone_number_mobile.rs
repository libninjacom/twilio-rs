...
#[derive(Clone)]
pub struct ListAvailablePhoneNumberMobileRequest<'a> {
...
impl<'a> ListAvailablePhoneNumberMobileRequest<'a> {
...
impl<'a> ::std::future::IntoFuture for ListAvailablePhoneNumberMobileRequest<'a> {
