...
#[derive(Clone)]
pub struct ListRecordingTranscriptionRequest<'a> {
...
impl<'a> ListRecordingTranscriptionRequest<'a> {
...
impl<'a> ::std::future::IntoFuture for ListRecordingTranscriptionRequest<'a> {
