...
#[derive(Clone)]
pub struct ListSipIpAccessControlListMappingRequest<'a> {
...
impl<'a> ListSipIpAccessControlListMappingRequest<'a> {
...
impl<'a> ::std::future::IntoFuture for ListSipIpAccessControlListMappingRequest<'a> {
