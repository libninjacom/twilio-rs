...
#[derive(Clone)]
pub struct CreateSipIpAccessControlListMappingRequest<'a> {
    pub(crate) http_client: &'a TwilioClient,
    pub account_sid: String,
    pub domain_sid: String,
}
impl<'a> CreateSipIpAccessControlListMappingRequest<'a> {
    pub async fn send(
        self,
...
impl<'a> ::std::future::IntoFuture for CreateSipIpAccessControlListMappingRequest<'a> {
