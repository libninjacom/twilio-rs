...
#[derive(Clone)]
pub struct ListUsageRecordDailyRequest<'a> {
...
impl<'a> ListUsageRecordDailyRequest<'a> {
    pub async fn send(self) -> ::httpclient::InMemoryResult<serde_json::Value> {
        let mut r = self
            ...
            .get(
                &format!(
                    "/2010-04-01/Accounts/{account_sid}/Usage/Records/Daily.json",
...
impl<'a> ::std::future::IntoFuture for ListUsageRecordDailyRequest<'a> {
