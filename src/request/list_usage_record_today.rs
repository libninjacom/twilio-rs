...
#[derive(Clone)]
pub struct ListUsageRecordTodayRequest<'a> {
...
impl<'a> ListUsageRecordTodayRequest<'a> {
    pub async fn send(self) -> ::httpclient::InMemoryResult<serde_json::Value> {
        let mut r = self
            ...
            .get(
                &format!(
                    "/2010-04-01/Accounts/{account_sid}/Usage/Records/Today.json",
...
impl<'a> ::std::future::IntoFuture for ListUsageRecordTodayRequest<'a> {
