...
#[derive(Clone)]
pub struct ListCallEventRequest<'a> {
...
impl<'a> ListCallEventRequest<'a> {
    pub async fn send(self) -> ::httpclient::InMemoryResult<serde_json::Value> {
        let mut r = self
            ...
            .get(
                &format!(
                    "/2010-04-01/Accounts/{account_sid}/Calls/{call_sid}/Events.json",
...
impl<'a> ::std::future::IntoFuture for ListCallEventRequest<'a> {
