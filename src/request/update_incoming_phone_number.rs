...
#[derive(Clone)]
pub struct UpdateIncomingPhoneNumberRequest<'a> {
    pub(crate) http_client: &'a TwilioClient,
    pub account_sid: String,
    pub sid: String,
}
impl<'a> UpdateIncomingPhoneNumberRequest<'a> {
    pub async fn send(
        self,
...
impl<'a> ::std::future::IntoFuture for UpdateIncomingPhoneNumberRequest<'a> {
