...
#[derive(Clone)]
pub struct ListAvailablePhoneNumberNationalRequest<'a> {
...
impl<'a> ListAvailablePhoneNumberNationalRequest<'a> {
...
impl<'a> ::std::future::IntoFuture for ListAvailablePhoneNumberNationalRequest<'a> {
