...
#[derive(Clone)]
pub struct ListIncomingPhoneNumberLocalRequest<'a> {
...
impl<'a> ListIncomingPhoneNumberLocalRequest<'a> {
...
impl<'a> ::std::future::IntoFuture for ListIncomingPhoneNumberLocalRequest<'a> {
