...
#[derive(Clone)]
pub struct ListAvailablePhoneNumberLocalRequest<'a> {
...
impl<'a> ListAvailablePhoneNumberLocalRequest<'a> {
...
impl<'a> ::std::future::IntoFuture for ListAvailablePhoneNumberLocalRequest<'a> {
