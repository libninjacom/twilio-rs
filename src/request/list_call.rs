        ...
        let mut r = self
            ...
            .get(
                &format!(
                    ...
                    .account_sid, end_time_gt = self.end_time_gt, end_time_lt = self
                    .end_time_lt, start_time_gt = self.start_time_gt, start_time_lt =
                    self.start_time_lt
                ),
            );
