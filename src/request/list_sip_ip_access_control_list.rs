...
#[derive(Clone)]
pub struct ListSipIpAccessControlListRequest<'a> {
...
impl<'a> ListSipIpAccessControlListRequest<'a> {
...
impl<'a> ::std::future::IntoFuture for ListSipIpAccessControlListRequest<'a> {
