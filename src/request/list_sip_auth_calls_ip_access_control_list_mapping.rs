...
#[derive(Clone)]
pub struct ListSipAuthCallsIpAccessControlListMappingRequest<'a> {
...
impl<'a> ListSipAuthCallsIpAccessControlListMappingRequest<'a> {
...
for ListSipAuthCallsIpAccessControlListMappingRequest<'a> {
