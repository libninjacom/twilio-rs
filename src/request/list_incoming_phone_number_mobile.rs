...
#[derive(Clone)]
pub struct ListIncomingPhoneNumberMobileRequest<'a> {
...
impl<'a> ListIncomingPhoneNumberMobileRequest<'a> {
...
impl<'a> ::std::future::IntoFuture for ListIncomingPhoneNumberMobileRequest<'a> {
