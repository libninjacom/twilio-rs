...
#[derive(Clone)]
pub struct DeleteSipIpAccessControlListMappingRequest<'a> {
    pub(crate) http_client: &'a TwilioClient,
    pub account_sid: String,
    pub domain_sid: String,
    pub sid: String,
}
impl<'a> DeleteSipIpAccessControlListMappingRequest<'a> {
...
impl<'a> ::std::future::IntoFuture for DeleteSipIpAccessControlListMappingRequest<'a> {
