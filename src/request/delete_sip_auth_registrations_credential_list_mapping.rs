...
#[derive(Clone)]
pub struct DeleteSipAuthRegistrationsCredentialListMappingRequest<'a> {
    pub(crate) http_client: &'a TwilioClient,
    pub account_sid: String,
    pub domain_sid: String,
    pub sid: String,
}
impl<'a> DeleteSipAuthRegistrationsCredentialListMappingRequest<'a> {
...
for DeleteSipAuthRegistrationsCredentialListMappingRequest<'a> {
