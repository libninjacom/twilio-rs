...
#[derive(Clone)]
pub struct ListAvailablePhoneNumberVoipRequest<'a> {
...
impl<'a> ListAvailablePhoneNumberVoipRequest<'a> {
...
impl<'a> ::std::future::IntoFuture for ListAvailablePhoneNumberVoipRequest<'a> {
