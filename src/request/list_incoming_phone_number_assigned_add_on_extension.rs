...
#[derive(Clone)]
pub struct ListIncomingPhoneNumberAssignedAddOnExtensionRequest<'a> {
...
impl<'a> ListIncomingPhoneNumberAssignedAddOnExtensionRequest<'a> {
        ...
        let mut r = self
            ...
            .get(
                &format!(
                    ...
                    .assigned_add_on_sid, resource_sid = self.resource_sid
                ),
            );
...
for ListIncomingPhoneNumberAssignedAddOnExtensionRequest<'a> {
