...
#[derive(Clone)]
pub struct ListAuthorizedConnectAppRequest<'a> {
...
impl<'a> ListAuthorizedConnectAppRequest<'a> {
    pub async fn send(self) -> ::httpclient::InMemoryResult<serde_json::Value> {
        let mut r = self
            ...
            .get(
                &format!(
                    "/2010-04-01/Accounts/{account_sid}/AuthorizedConnectApps.json",
...
impl<'a> ::std::future::IntoFuture for ListAuthorizedConnectAppRequest<'a> {
