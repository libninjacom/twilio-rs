...
#[derive(Clone)]
pub struct ListSipAuthCallsCredentialListMappingRequest<'a> {
...
impl<'a> ListSipAuthCallsCredentialListMappingRequest<'a> {
...
impl<'a> ::std::future::IntoFuture for ListSipAuthCallsCredentialListMappingRequest<'a> {
