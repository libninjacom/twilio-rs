...
#[derive(Clone)]
pub struct ListUsageRecordMonthlyRequest<'a> {
...
impl<'a> ListUsageRecordMonthlyRequest<'a> {
    pub async fn send(self) -> ::httpclient::InMemoryResult<serde_json::Value> {
        let mut r = self
            ...
            .get(
                &format!(
                    "/2010-04-01/Accounts/{account_sid}/Usage/Records/Monthly.json",
...
impl<'a> ::std::future::IntoFuture for ListUsageRecordMonthlyRequest<'a> {
