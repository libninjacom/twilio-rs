...
#[derive(Clone)]
pub struct DeleteIncomingPhoneNumberAssignedAddOnRequest<'a> {
    pub(crate) http_client: &'a TwilioClient,
    pub account_sid: String,
    pub resource_sid: String,
    pub sid: String,
}
impl<'a> DeleteIncomingPhoneNumberAssignedAddOnRequest<'a> {
...
for DeleteIncomingPhoneNumberAssignedAddOnRequest<'a> {
