...
#[derive(Clone)]
pub struct DeleteSipCredentialListMappingRequest<'a> {
    pub(crate) http_client: &'a TwilioClient,
    pub account_sid: String,
    pub domain_sid: String,
    pub sid: String,
}
impl<'a> DeleteSipCredentialListMappingRequest<'a> {
...
impl<'a> ::std::future::IntoFuture for DeleteSipCredentialListMappingRequest<'a> {
