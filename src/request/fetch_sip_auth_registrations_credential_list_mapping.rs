...
#[derive(Clone)]
pub struct FetchSipAuthRegistrationsCredentialListMappingRequest<'a> {
    pub(crate) http_client: &'a TwilioClient,
    pub account_sid: String,
    pub domain_sid: String,
    pub sid: String,
}
impl<'a> FetchSipAuthRegistrationsCredentialListMappingRequest<'a> {
    pub async fn send(
        self,
...
for FetchSipAuthRegistrationsCredentialListMappingRequest<'a> {
