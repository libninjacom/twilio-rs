...
#[derive(Clone)]
pub struct ListDependentPhoneNumberRequest<'a> {
...
impl<'a> ListDependentPhoneNumberRequest<'a> {
        ...
        let mut r = self
            ...
            .get(
                &format!(
                    ...
                    account_sid = self.account_sid, address_sid = self.address_sid
                ),
            );
...
impl<'a> ::std::future::IntoFuture for ListDependentPhoneNumberRequest<'a> {
