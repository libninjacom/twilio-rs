...
#[derive(Clone)]
pub struct FetchRecordingAddOnResultPayloadRequest<'a> {
...
impl<'a> FetchRecordingAddOnResultPayloadRequest<'a> {
    pub async fn send(
        self,
...
pub struct FetchRecordingAddOnResultPayloadRequired<'a> {
    pub account_sid: &'a str,
    pub add_on_result_sid: &'a str,
    pub reference_sid: &'a str,
    pub sid: &'a str,
}
impl<'a> FetchRecordingAddOnResultPayloadRequired<'a> {}
impl<'a> ::std::future::IntoFuture for FetchRecordingAddOnResultPayloadRequest<'a> {
