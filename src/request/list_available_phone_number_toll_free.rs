...
#[derive(Clone)]
pub struct ListAvailablePhoneNumberTollFreeRequest<'a> {
...
impl<'a> ListAvailablePhoneNumberTollFreeRequest<'a> {
...
impl<'a> ::std::future::IntoFuture for ListAvailablePhoneNumberTollFreeRequest<'a> {
