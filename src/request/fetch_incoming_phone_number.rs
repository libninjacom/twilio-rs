...
#[derive(Clone)]
pub struct FetchIncomingPhoneNumberRequest<'a> {
    pub(crate) http_client: &'a TwilioClient,
    pub account_sid: String,
    pub sid: String,
}
impl<'a> FetchIncomingPhoneNumberRequest<'a> {
    pub async fn send(
        self,
...
impl<'a> ::std::future::IntoFuture for FetchIncomingPhoneNumberRequest<'a> {
