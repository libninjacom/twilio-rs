...
#[derive(Clone)]
pub struct ListAvailablePhoneNumberSharedCostRequest<'a> {
...
impl<'a> ListAvailablePhoneNumberSharedCostRequest<'a> {
...
impl<'a> ::std::future::IntoFuture for ListAvailablePhoneNumberSharedCostRequest<'a> {
