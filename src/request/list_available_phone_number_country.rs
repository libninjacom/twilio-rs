...
#[derive(Clone)]
pub struct ListAvailablePhoneNumberCountryRequest<'a> {
...
impl<'a> ListAvailablePhoneNumberCountryRequest<'a> {
    pub async fn send(self) -> ::httpclient::InMemoryResult<serde_json::Value> {
        let mut r = self
            ...
            .get(
                &format!(
                    "/2010-04-01/Accounts/{account_sid}/AvailablePhoneNumbers.json",
...
impl<'a> ::std::future::IntoFuture for ListAvailablePhoneNumberCountryRequest<'a> {
