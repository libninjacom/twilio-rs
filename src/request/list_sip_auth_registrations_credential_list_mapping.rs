...
#[derive(Clone)]
pub struct ListSipAuthRegistrationsCredentialListMappingRequest<'a> {
...
impl<'a> ListSipAuthRegistrationsCredentialListMappingRequest<'a> {
...
for ListSipAuthRegistrationsCredentialListMappingRequest<'a> {
