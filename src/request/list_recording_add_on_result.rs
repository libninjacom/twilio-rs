...
#[derive(Clone)]
pub struct ListRecordingAddOnResultRequest<'a> {
...
impl<'a> ListRecordingAddOnResultRequest<'a> {
    pub async fn send(self) -> ::httpclient::InMemoryResult<serde_json::Value> {
        let mut r = self
            ...
            .get(
                &format!(
                    "/2010-04-01/Accounts/{account_sid}/Recordings/{reference_sid}/AddOnResults.json",
...
impl<'a> ::std::future::IntoFuture for ListRecordingAddOnResultRequest<'a> {
