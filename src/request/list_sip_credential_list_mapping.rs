...
#[derive(Clone)]
pub struct ListSipCredentialListMappingRequest<'a> {
...
impl<'a> ListSipCredentialListMappingRequest<'a> {
...
impl<'a> ::std::future::IntoFuture for ListSipCredentialListMappingRequest<'a> {
