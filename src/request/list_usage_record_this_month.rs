...
#[derive(Clone)]
pub struct ListUsageRecordThisMonthRequest<'a> {
...
impl<'a> ListUsageRecordThisMonthRequest<'a> {
...
impl<'a> ::std::future::IntoFuture for ListUsageRecordThisMonthRequest<'a> {
