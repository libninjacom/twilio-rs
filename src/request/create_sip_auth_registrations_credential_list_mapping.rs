...
#[derive(Clone)]
pub struct CreateSipAuthRegistrationsCredentialListMappingRequest<'a> {
    pub(crate) http_client: &'a TwilioClient,
    pub account_sid: String,
    pub domain_sid: String,
}
impl<'a> CreateSipAuthRegistrationsCredentialListMappingRequest<'a> {
    pub async fn send(
        self,
...
for CreateSipAuthRegistrationsCredentialListMappingRequest<'a> {
