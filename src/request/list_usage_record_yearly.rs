...
#[derive(Clone)]
pub struct ListUsageRecordYearlyRequest<'a> {
...
impl<'a> ListUsageRecordYearlyRequest<'a> {
    pub async fn send(self) -> ::httpclient::InMemoryResult<serde_json::Value> {
        let mut r = self
            ...
            .get(
                &format!(
                    "/2010-04-01/Accounts/{account_sid}/Usage/Records/Yearly.json",
...
impl<'a> ::std::future::IntoFuture for ListUsageRecordYearlyRequest<'a> {
