...
#[derive(Clone)]
pub struct FetchSipCredentialListMappingRequest<'a> {
    pub(crate) http_client: &'a TwilioClient,
    pub account_sid: String,
    pub domain_sid: String,
    pub sid: String,
}
impl<'a> FetchSipCredentialListMappingRequest<'a> {
    pub async fn send(
        self,
...
impl<'a> ::std::future::IntoFuture for FetchSipCredentialListMappingRequest<'a> {
