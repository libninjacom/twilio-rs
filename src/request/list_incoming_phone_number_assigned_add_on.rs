...
#[derive(Clone)]
pub struct ListIncomingPhoneNumberAssignedAddOnRequest<'a> {
...
impl<'a> ListIncomingPhoneNumberAssignedAddOnRequest<'a> {
...
impl<'a> ::std::future::IntoFuture for ListIncomingPhoneNumberAssignedAddOnRequest<'a> {
